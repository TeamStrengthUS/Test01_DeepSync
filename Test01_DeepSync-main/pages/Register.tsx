      ...
      <div className="flex-1 flex items-center justify-center p-8 lg:p-24 bg-lightSurface dark:bg-void relative overflow-y-auto transition-colors duration-300">
        <div className="w-full max-w-md py-12">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            {message && (
              <div className="p-4 border border-teal/20 bg-teal/5 rounded-2xl text-teal text-xs font-bold">
                {message}
              </div>
            )}
            ...
            >
              <span className="relative z-10">{loading ? 'Creating...' : 'Initialize Workspace'}</span>
