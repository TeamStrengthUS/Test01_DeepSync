...
-- Extensions required for UUIDs and vector search
...
CREATE TABLE public.teammate_node (
    ...
    agent_callsign TEXT DEFAULT 'Alpha-1',
    agent_role TEXT DEFAULT 'generalist',
    name TEXT DEFAULT 'Alpha-Node',
    mesh_location TEXT DEFAULT 'PHX-01',
    mesh_container_id TEXT,
