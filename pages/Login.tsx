          ...
          <div className="w-full max-w-md">
            ...
            <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); navigate('/dashboard'); }}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button type="button" className="py-4 bg-white dark:bg-surface border border-slate-200 dark:border-white/10 rounded-2xl flex items-center justify-center gap-3 hover:bg-slate-50 dark:hover:bg-white/10 transition-all font-black text-xs uppercase tracking-widest text-slate-600 dark:text-white shadow-sm dark:shadow-none">
