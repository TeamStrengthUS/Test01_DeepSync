...
async def respond(ctx: JobContext, user_msg):
    try:
        ...
        # FIX: Change topic from "lk.chat" to "chat"
        # The log "ignoring text stream with topic 'lk.chat'" proved the frontend
        # sees the message but drops it. Changing to "chat" usually fixes this
